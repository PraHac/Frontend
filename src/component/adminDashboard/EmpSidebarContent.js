...
export default function EmpSidebarContent() {
	...
	const createSupervisor = (e) => {
		e.preventDefault();
		axios.post("http://localhost:8081/r1/addSupervisor", {
	...
	const createEmployee = (e) => {
		e.preventDefault();
		axios.put("http://localhost:8081/r1/addEmployeesToSupervisor", {
	...
	const createAccountant = (e) => {
		e.preventDefault();
		axios.post("http://localhost:8081/r1/addAccountant", {
				name: accountantName,
