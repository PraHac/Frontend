...
class PaySalarySidebarContent extends React.Component{
  ...
  accApproved = (e) => {
    ...
    axios
    .get(
      "http://localhost:8081/r1/allAccountantApproved"
    )
    .then((res) => {
    ...
    axios
    .get(
      "http://localhost:8081/r1/allAccountantDisApproved"
    )
    .then((res) => {
      console.log(res.data);
  ...
  showMonthR = (e) => {
    ...
    axios
    .get(
      "http://localhost:8081/r1/monthlyReimburse"+"/"+this.state.monthHandle+"/"+this.state.yearHandle
    )
    .then((res) => {
      console.log(res.data);
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ marginLeft: "95px" }}>
                            ...
                            <p><Moment format="YYYY-MMM-DD ">{this.state.supervisorSingleDisR.dateOfReimburse}</Moment></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            <p><Moment format="YYYY-MMM-DD HH:mm:ss">{this.state.accountantSingleAppR.createdDate}</Moment></p>
                          </div>
                          <div style={{ marginLeft: "95px" }}>
                            <p style={{ fontWeight: "800" }} scope="col">
                              Date of Reimburse{" "}
                            </p>
                            <p><Moment format="YYYY-MMM-DD ">{this.state.accountantSingleAppR.dateOfReimburse}</Moment></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            <p><Moment format="YYYY-MMM-DD HH:mm:ss">{this.state.accountantSingleDisR.createdDate}</Moment></p>
                          </div>
                          <div style={{ marginLeft: "95px" }}>
                            <p style={{ fontWeight: "800" }} scope="col">
                              Date of Reimburse{" "}
                            </p>
                            <p><Moment format="YYYY-MMM-DD ">{this.state.accountantSingleDisR.dateOfReimburse}</Moment></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            <p><Moment format="YYYY-MMM-DD HH:mm:ss">{this.state.singleMonthReim.createdDate}</Moment></p>
                          </div>
                          <div style={{ marginLeft: "95px" }}>
                            <p style={{ fontWeight: "800" }} scope="col">
                              Date of Reimburse{" "}
                            </p>
                            <p><Moment format="YYYY-MMM-DD ">{this.state.singleMonthReim.dateOfReimburse}</Moment></p>
                          </div>
                        </div>
                      </div>
                    </div>
